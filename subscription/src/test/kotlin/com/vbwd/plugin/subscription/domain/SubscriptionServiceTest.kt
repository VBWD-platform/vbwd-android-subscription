...
class SubscriptionServiceTest {
    ...
    @Test
    fun `fetchPlans appends the currency query`() =
        runTest {
    ...
    @Test
    fun `fetchActiveSub unwraps the subscription`() =
        runTest {
            coEvery {
    ...
    @Test
    fun `fetchPlan reads the plan from the top level`() =
        runTest {
    ...
    @Test
    fun `fetchUserAddOn raises when the body is empty (no false success)`() =
        runTest {
    ...
    @Test
    fun `cancelSubscription posts to the cancel endpoint`() =
        runTest {
            coEvery {
